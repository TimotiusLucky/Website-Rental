            ...
            <div style="margin-bottom: 50px;" class="content col-lg-12 col-lg-offset-2">
              ...
              <div style="padding-bottom: 70px;" class="cont-form">
                ...
                while($data = mysqli_fetch_array($pesanan)){
                  ...
                  <?php if($data['sts_pesanan'] == 1){ ?>

                      <a style="float: right; margin-left: 10px;" class="btn btn-success btn-md text-uppercase" href="../config/hitungdenda?kd_pesanan=<?php echo $data['kd_pesanan'] ?>&kd_transaksi=<?php echo $data['kd_transaksi'] ?>">Pengembalian Mobil</a>

                  <?php }?>

                    <a style="float: right;" class="btn btn-primary btn-md text-uppercase" href="pesanan-index">Kembali</a>
