...
<html lang="en">
      ...
      <div id="page-content-wrapper">
        ...
        <div class="container">
          ...
          if(isset($_GET['pesan'])){
            ...
            if($_GET['pesan']=="tambahAdmin"){

              echo "<div class='alert alert-secondary'>Berhasil Menambahkan Admin</div>";

            }

            if($_GET['pesan']=="hapusAdmin"){

              echo "<div class='alert alert-secondary'>Berhasil Menghapus Admin</div>";
            ...
            <div style="margin-bottom: 50px;" class="content col-lg-12 col-lg-offset-2">
              ...
              <div class="col-md-12">
                <div class="input-group mb-3">
                  <input type="text" class="form-control" placeholder="Cari Admin..." id="search">
              ...
              <div style="padding: 0px 20px;">
                  ...
                  <table class="table table-font" style="width: 100%">
                    ...
                    $datas          = mysqli_query($conn, "SELECT * FROM akun WHERE level='admin'");

                    $jumlah_data    = mysqli_num_rows($datas);

                    $total_halaman  = ceil($jumlah_data / $limit);

                    $data_akun      = mysqli_query($conn, "SELECT * FROM akun WHERE level='admin' LIMIT $halaman_awal, $limit");
    ...
    window.location.href = '/web_rental/admin/adm-index';
    }
    </script>
